...
namespace BlogEngineSGC.Controllers
{
    public class BlogController : Controller
    {
        ...
        private readonly IOptionsSnapshot<BlogsSettings> settings;

        public BlogController(IBlogService blog,
            IOptionsSnapshot<BlogsSettings> settings,
        ...
        /// <remarks>This is for redirecting potential existing URLs from the old blog URL format.</remarks>
        [Route("/post/{slug}")]
        [HttpGet]
